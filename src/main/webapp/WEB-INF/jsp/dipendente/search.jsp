			...
			<div class='card'>
			    ...
			    <div class='card-body'>
						...
						<form method="post" action="${pageContext.request.contextPath}/dipendente/list" class="row g-3">
							...
							<div class="col-md-6">
								<label for="codFis" class="form-label">CodiceFiscale</label>
								<input type="text" class="form-control" name="codFis" id="codFis" placeholder="Inserire il codiceFiscale" >
							</div>
							
							<div class="col-md-6">
								<label for="email" class="form-label">Email</label>
								<input type="text" class="form-control" name="email" id="email" placeholder="Inserire l'email" >
							</div>
