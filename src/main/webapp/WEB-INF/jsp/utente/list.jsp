...
<body class="d-flex flex-column h-100">
			                	...
			                	<c:forEach items="${utente_list_attribute }" var="utenteItem">
									<tr>
										...
										<td>
											...
											<a id="changePasswordLink${utenteItem.id }" class="btn btn-outline-warning btn-sm link-for-modalPassword" data-bs-toggle="modal" data-bs-target="#confirmOperationModalPassword"  >FastReset</a>
										</td>
									</tr>
								</c:forEach>
			                </tbody>
	...
	<div class="modal fade" id="confirmOperationModalPassword" tabindex="-1"  aria-labelledby="confirmOperationModalPasswordLabel"
	    aria-hidden="true">
	    <div class="modal-dialog" >
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="confirmOperationModalPasswordLabel">Conferma Operazione</h5>
	                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	            </div>
	            <div class="modal-body">
	                Continuare con l'operazione?
	            </div>
	            <form method="post" action="${pageContext.request.contextPath}/utente/cambiaPassword" >
		            <div class="modal-footer">
	...
	<script type="text/javascript">
		<!-- aggancio evento click al conferma del modal  -->
		$(".link-for-modalPassword").click(function(){
			<!-- mi prendo il numero che poi sarà l'id. Il 18 è perché 'changeStatoLink_#_' è appunto lungo 18  -->
			var callerId = $(this).attr('id').substring(18);
			<!-- imposto nell'hidden del modal l'id da postare alla servlet -->
